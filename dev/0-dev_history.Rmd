...
fusen::fill_description(
  pkg = here::here(),
  fields = list(
    Title = "Un Package Qui Sert A Compter Le Nombre De Lignes",
    Description = "Le package sert à compter le nombre de lignes de mon dataframe.",
    `Authors@R` = c(
      person("Ombeline", "JDP", email = "ombeline.julliendepommerol@sciencespo.fr", role = c("aut", "cre"), comment = c(ORCID = "0000-0000-0000-0000"))
    )
  )
)
